...
print("=========================")
print("Step 6A — Pixel + Calibrated Depth")
print(f"MAE (mm): {mae_D:.2f}")

print("\n=========================")
print("Step 6B — Pixel + Calibrated Depth - T-Norm")
...
print("\nFeature Importance — Pixel + Calibrated Depth:")
print(fi_D.sort_values(ascending=False))

print("\nFeature Importance — Pixel + Calibrated Depth - T-Norm:")
